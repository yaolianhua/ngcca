...
public class KubernetesClusterRabbitMQMessageSubscriber {
    ...
    public void subscribe(String message) {
        ...
        List<String> masterIpList = kubernetesClusters.stream()
                ...
                .map(io.hotcloud.db.core.cluster.Node::getIp)
                .toList();
        ...
        for (Node master : masters) {
            ...
            io.hotcloud.db.core.cluster.Node mNode = new io.hotcloud.db.core.cluster.Node();
        ...
        for (Node node : nodes) {
            io.hotcloud.db.core.cluster.Node nNode = new io.hotcloud.db.core.cluster.Node();
