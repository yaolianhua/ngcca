...
public final class Views {
    ...
    public static final String TEMPLATE_DEFINITION_EDIT_FRAGMENT = "admin/template-definition/template-edit::content";
    public static final String TEMPLATE_DEFINITION_DETAIL_FRAGMENT = "admin/template-definition/template-detail::content";
