...
import io.hotcloud.security.api.jwt.PayloadClaims;
...
public class JwtManager implements JwtSigner, JwtVerifier {
    ...
    @Override
    public String sign(io.hotcloud.security.api.jwt.Jwt jwt) {
    ...
    @Override
    public io.hotcloud.security.api.jwt.Jwt verify(String sign) {
        SecretKey secretKey = Keys.hmacShaKeyFor(Base64.getEncoder().encode(io.hotcloud.security.api.jwt.Jwt.SECRET.getBytes(StandardCharsets.UTF_8)));
        ...
        return new io.hotcloud.security.api.jwt.Jwt() {
            ...
            public PayloadClaims payload() {
                ...
                io.hotcloud.security.api.jwt.Jwt.DEFAULT_CLAIMS.forEach(claims::remove);
