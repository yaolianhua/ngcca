...
RUN wget -q http://119.91.214.25:8888/java/tomcat-10.1.16.tar.gz -O /tmp/apache-tomcat-10.1.16.tar.gz
RUN mkdir -p /home/admin/tomcat && tar -xf /tmp/apache-tomcat-10.1.16.tar.gz -C /home/admin/tomcat --strip-components 1
RUN rm -rf /tmp/apache-tomcat-10.1.16.tar.gz && chmod +x $CATALINA_HOME/bin/*sh
