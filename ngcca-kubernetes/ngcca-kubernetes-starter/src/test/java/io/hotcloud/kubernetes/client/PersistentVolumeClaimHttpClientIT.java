...
public class PersistentVolumeClaimHttpClientIT extends ClientIntegrationTestBase {
    ...
    @Test
    public void read() {
        PersistentVolumeClaimList readList = persistentVolumeClaimHttpClient.readList(NAMESPACE, null);
        ...
        PersistentVolumeClaim result = persistentVolumeClaimHttpClient.read(NAMESPACE, PERSISTENT_VOLUME_CLAIM);
