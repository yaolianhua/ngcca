...
public final class UserViews {
    ...
    public static final String TEMPLATE_DEFINITION_LIST = "user/template/template-definition-list";
    public static final String INSTANCE_LIST = "user/template/instance-list";
    public static final String USER_APPLICATION = "user/application/application-list";
    public static final String USER_VOLUME = "user/volume/volume-list";
    ...
    public static final String USER_VOLUME_LIST_FRAGMENT = "user/volume/volume-list::content";
